...
import useDeleteAboutApp from "../../../../../api/About/useDeleteAboutApp";

const DeleteButton = () => {
    const [open, setOpen] = useState(false);
    const { t } = useTranslation();
    const deleteAbout = useDeleteAboutApp()
        ...
        >
          ...
          <DialogActions>
            ...
            <LoadingButton
              color="lighRed"
              variant="contained"
              loading={deleteAbout.isPending}
              onClick={async () => {
                await deleteAbout.mutateAsync();
                handleClose();
              }}
            >
              {t("dialog_delete")}
