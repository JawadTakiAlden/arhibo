            ...
            {({
              ...
              <form onSubmit={handleSubmit}>
                <FormControl color="success" fullWidth sx={{ mb: 1 }}>
                  <InputLabel>
                    {" "}
                    {t("EditValidationButton.regex_code")}
                  </InputLabel>
                  <OutlinedInput
                    label={t("EditValidationButton.regex_code")}
                    name="name"
                    value={values.name}
                ...
                <FormControl color="success" fullWidth sx={{ mb: 1 }}>
                  <InputLabel> {t("EditValidationButton.message")}</InputLabel>
                  <OutlinedInput
                    label={t("EditValidationButton.message")}
                    name="message"
                ...
                <FormControl color="success" fullWidth sx={{ mb: 1 }}>
                  <InputLabel>
                    {" "}
                    {t("EditValidationButton.message_ar")}
                  </InputLabel>
                  <OutlinedInput
                    label={t("EditValidationButton.message_ar")}
                    name="message_ar"
                ...
                <LoadingButton
                  loading={updateValidation.isPending}
                  type="submit"
                  fullWidth
                  variant="contained"
                  color="success"
