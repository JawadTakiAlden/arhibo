            ...
            {({
              ...
              <form onSubmit={handleSubmit}>
                <FormControl color="success" fullWidth sx={{ mb: 1 }}>
                  <InputLabel>
                    {t("InputOfCategoryForms.input_name")}
                  </InputLabel>
                  <OutlinedInput
                    label={t("InputOfCategoryForms.input_name")}
                    name="input_name"
                ...
                <FormControl color="success" fullWidth sx={{ mb: 1 }}>
                  <InputLabel>
                    {t("InputOfCategoryForms.input_name_ar")}
                  </InputLabel>
                  <OutlinedInput
                    label={t("InputOfCategoryForms.input_name_ar")}
                    name="input_name_ar"
                ...
                <FormControl color="success" fullWidth sx={{ mb: 1 }}>
                  <InputLabel>
                    {t("InputOfCategoryForms.placeholder_en")}
                  </InputLabel>
                  <OutlinedInput
                    label={t("InputOfCategoryForms.placeholder_en")}
                    name="placeholder"
                ...
                <FormControl color="success" fullWidth sx={{ mb: 1 }}>
                  <InputLabel>
                    {t("InputOfCategoryForms.placeholder_ar")}
                  </InputLabel>
                  <OutlinedInput
                    label={t("InputOfCategoryForms.placeholder_ar")}
                    name="placeholder_ar"
