...
const ShowCatgeory = Loadable(lazy(() => import("../views/pages/Category/ShowCatgeory")))
const InputsOfCategory = Loadable(lazy(() => import("../views/pages/Category/Inputs")))
const FiltersOfCategory = Loadable(lazy(() => import("../views/pages/Category/Filters")))
const CreateCatgeory = Loadable(lazy(() => import("../views/pages/Category/CreateCatgeory")))
const AllTemplate = Loadable(lazy(() => import("../views/pages/Template")))
const ShowTemplate = Loadable(lazy(() => import("../views/pages/Template/ShowTemplate")))
const CreateTemplate = Loadable(lazy(() => import("../views/pages/Template/CreateTemplate")))
const AllServices = Loadable(lazy(() => import("../views/pages/Services")))
const CreateService = Loadable(lazy(() => import("../views/pages/Services/CreateService")))
const ShowService = Loadable(lazy(() => import("../views/pages/Services/ShowService")))
const AllTerms = Loadable(lazy(() => import("../views/pages/Terms")))
const CreateTerm = Loadable(lazy(() => import("../views/pages/Terms/CreateTerm")))
const ShowTerm = Loadable(lazy(() => import("../views/pages/Terms/ShowTerm")))
const AllPolicy = Loadable(lazy(() => import("../views/pages/Policy")))
const CreatePolicy = Loadable(lazy(() => import("../views/pages/Policy/CreatePolicy")))
const ShowPolicy = Loadable(lazy(() => import("../views/pages/Policy/ShowPolicy")))
...
const CreateAbout = Loadable(lazy(() => import("../views/pages/About/CreateAbout")))
const ShowAbout = Loadable(lazy(() => import("../views/pages/About/ShowAbout")))
const AllCoupons = Loadable(lazy(() => import("../views/pages/Coupons")))
const ShowCoupon = Loadable(lazy(() => import("../views/pages/Coupons/ShowCoupon")))
const CreateCoupon = Loadable(lazy(() => import("../views/pages/Coupons/CreateCoupon")))
const ContactInfo = Loadable(lazy(() => import("../views/pages/Contact")))
const ProhibitedThings = Loadable(lazy(() => import("../views/pages/Prohibited")))
const CreateProhibited = Loadable(lazy(() => import("../views/pages/Prohibited/CreateProhibited")))
